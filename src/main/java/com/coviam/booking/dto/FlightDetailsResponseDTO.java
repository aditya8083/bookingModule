...
public class FlightDetailsResponseDTO  implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FlightDetailsResponseDTO)) return false;
        FlightDetailsResponseDTO that = (FlightDetailsResponseDTO) o;
    ...
    public String toString() {
        return "FlightDetailsResponseDTO{" +
                "flightId='" + flightId + '\'' +
                ", origin='" + origin + '\'' +
